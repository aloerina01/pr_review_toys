...
},{"preact":"aSor"}],"jPh6":[function(require,module,exports) {
"use strict";
...
var liStyle = function liStyle(isFirst) {
  return {
    padding: '8px 10px',
...
},{"preact/jsx-runtime":"yOgR"}],"JkLE":[function(require,module,exports) {
"use strict";
...
exports.Toy = Toy;
},{"preact/jsx-runtime":"yOgR","preact/hooks":"MwGB","./Intentions":"jPh6"}],"zo2T":[function(require,module,exports) {
"use strict";
...
var renderToy = function renderToy(targetTabConteiner) {
  ...
  toolbars.forEach(function (toolbar) {
    ...
    var isAlreadyAppended = toolbarItems.some(function (toolbarItem) {
      ...
      return (_a = toolbarItem.className) === null || _a === void 0 ? void 0 : _a.includes('custom-toy');
    });
...
},{"preact/jsx-runtime":"yOgR","preact":"aSor","./components/Toy":"JkLE"}]},{},["zo2T"], null)
